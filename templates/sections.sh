SECTIONS=(mode mounts workspaces python gpu egress netaccess hostroute ssh bashrc mcp-servers agents codex-mcp continuity claude-md settings hooks git-identity apt-extra binaries restart-policy)
...
SEC_VARS[netaccess]='CBOX_NETACCESS_MODE CBOX_NETACCESS_APPLIED CBOX_NETACCESS_NETWORKS CBOX_NETACCESS_SOCKS_PORT'
