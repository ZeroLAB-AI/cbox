SECTIONS=(mode mounts workspaces python gpu egress netaccess hostroute ssh bashrc mcp-servers codex-progress local-model autoresume agents codex-mcp continuity claude-md settings hooks git-identity apt-extra binaries restart-policy)

declare -A SEC_TITLE SEC_DESC SEC_VARS SEC_APPLY SEC_PROFILE SEC_DEPS SEC_DEP_TEXT SEC_DOCTOR_ROWS
...
DOCTOR_EXTRA_ROWS='codex-profile context-manifest local-model managed-dirs'
